...

{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/a4fc302d-b9a3-4c09-828d-d2f3758760cd";
    fsType = "ext4";
  };

  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/1251-4366";
    fsType = "vfat";
    options = [
      "fmask=0077"
      "dmask=0077"
  ...
  swapDevices = [
    { device = "/dev/disk/by-uuid/4703f6e0-9bbb-4b99-b81f-25765ce248a4"; }
  ];
