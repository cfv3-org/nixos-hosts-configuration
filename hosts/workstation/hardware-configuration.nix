...

{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/4ebd1bd4-6ef3-4def-bc24-8e29c309b344";
    fsType = "ext4";
  };

  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/641A-A7BB";
    fsType = "vfat";
    options = [
      "fmask=0077"
      "dmask=0077"
  ...
  swapDevices = [
    { device = "/dev/disk/by-uuid/6f746cf5-02d2-4d55-be49-e368f168d814"; }
  ];
